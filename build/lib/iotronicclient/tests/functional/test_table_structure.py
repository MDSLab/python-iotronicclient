...
class TableStructureIotronicCLITests(base.FunctionalTestBase):
    """Basic, read-only table structure tests for Iotronic CLI commands.

    Basic smoke tests for the Iotronic CLI commands to check table structure
    which do not require creating or modifying Iotronic objects.
    """
