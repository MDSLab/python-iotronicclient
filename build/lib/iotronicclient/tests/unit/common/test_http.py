...
def _session_client(**kwargs):
    return http.SessionClient(os_iotronic_api_version='1.6',
...
class VersionNegotiationMixinTest(utils.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.test_object.os_iotronic_api_version = '1.6'
    ...
    def test__generic_parse_version_headers_has_headers(self):
        response = {'X-OpenStack-Iotronic-API-Minimum-Version': '1.1',
                    'X-OpenStack-Iotronic-API-Maximum-Version': '1.6',
                    }
        expected = ('1.1', '1.6')
    ...
    def test_negotiate_version_server_no_version_on_error(
        ...
        # Test older Iotronic version which errored with no version number and
    ...
    def test_negotiate_version_server_explicit_too_high(self, mock_pvh,
        ...
        self.test_object.os_iotronic_api_version = '99.99'
        self.assertRaises(
    ...
    def test_negotiate_version_server_explicit_not_supported(self, mock_pvh,
        ...
        self.test_object.os_iotronic_api_version = '1.5'
        self.assertRaises(
            exc.UnsupportedVersion,
            self.test_object.negotiate_version,
            mock_conn, self.response)
    ...
    def test_get_server(self):
        host = 'iotronic-host'
        port = '6385'
        endpoint = 'http://%s:%s/iotronic/v1/' % (host, port)
...
class HttpClientTest(utils.BaseTestCase):
    ...
    def test__parse_version_headers(self):
        ...
        fake_resp = utils.FakeSessionResponse(
            {'X-OpenStack-Iotronic-API-Minimum-Version': '1.1',
             'X-OpenStack-Iotronic-API-Maximum-Version': '1.6',
             'Content-Type': 'text/plain',
             },
            six.StringIO(error_body),
    ...
    def test__http_request_client_fallback_fail(self, mock_save_data):
        ...
        client.session = utils.FakeSession(
            {'X-OpenStack-Iotronic-API-Minimum-Version': '1.1',
             'X-OpenStack-Iotronic-API-Maximum-Version': latest_ver,
             'content-type': 'text/plain',
             },
            six.StringIO(error_body),
            version=1,
