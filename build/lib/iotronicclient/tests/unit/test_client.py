...
from iotronicclient import client as iroclient
...
from iotronicclient.v1 import client as v1


class ClientTest(utils.BaseTestCase):

    def test_get_client_with_auth_token_iotronic_url(self):
        kwargs = {
        ...
        self.assertEqual('http://iotronic.example.org:6385/',
    ...
    def _test_get_client(self, mock_ks_loader, mock_ks_session,
        ...
        session.get_endpoint.assert_called_once_with(
            service_type=kwargs.get('os_service_type') or 'iot',
            interface=kwargs.get('os_endpoint_type') or 'publicURL',
            region_name=kwargs.get('os_region_name'))
        if 'os_iotronic_api_version' in kwargs:
            ...
            self.assertEqual(version or v1.DEFAULT_VER,
                             client.http_client.os_iotronic_api_version)
    ...
    def test_get_client_with_api_version_latest(self):
        kwargs = {
            ...
            'os_auth_url': 'http://localhost:35357/v2.0',
            'os_auth_token': '',
            'os_iotronic_api_version': "latest",
        }
        self._test_get_client(**kwargs)
    ...
    def test_get_client_only_session_passed(self):
        ...
        session.get_endpoint.assert_called_once_with(service_type='iot',
                                                     interface='publicURL',
                                                     region_name=None)
    ...
    def _test_loader_arguments_passed_correctly(
        ...
        session.get_endpoint.assert_called_once_with(
            service_type=passed_kwargs.get('os_service_type') or 'iot',
    ...
    def test_correct_arguments_passed_to_client_constructor_noauth_mode(
        ...
        mock_client.assert_called_once_with(
            '1', 'http://iotronic.example.org:6385/',
            **{
                'os_iotronic_api_version': 'latest',
                'max_retries': 10,
                'retry_interval': 10,
